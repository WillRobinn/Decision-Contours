...
# The following is code used to create statistical significance contours as per Langan et al. (3)
# The code for the rest of the figures is adapted from this code
# To create figure 2.1 I simply used the relative risks and standard errors of the natural logarithm of the log relative risks from the example dataset
# The function call is on line 595 at the bottom of the script
...
RR <- c(0.157895,0.498016,0.324114,0.178804,0.333333)
selnRR <- c(0.615225,0.701461,0.341625,0.403829,0.656167)
